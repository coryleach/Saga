...
public class FighterProfession extends Profession {
	 ...
	 * Profession name.
	 */
	private static final String PROFESSION_NAME="fighter";
	 ...
	 * Ability names.
	 */
	private static final String[] ABILITY_NAMES={"none","heavy hit","counterattack","disarm"};


	// Initialization, loading and saving:
	public FighterProfession(Properties pBalanceInformation, Properties pPlayerInformation, Saga pPlugin, SagaPlayer pPlayer) {
